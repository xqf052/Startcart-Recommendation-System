...
def main():
    ...
    up_features = glueContext.create_dynamic_frame.from_catalog(database="prod-gp5", table_name="up_features")
    prd_features = glueContext.create_dynamic_frame.from_catalog(database="prod-gp5", table_name="prd_features")
    user_features_1 = glueContext.create_dynamic_frame.from_catalog(database="prod-gp5", table_name="user_features_1")
    user_features_2 = glueContext.create_dynamic_frame.from_catalog(database="prod-gp5", table_name="user_features_2")
